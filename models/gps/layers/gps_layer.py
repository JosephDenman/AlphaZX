...
from models.gps.layers.bigbird_layer import SingleBigBirdLayer
from models.gps.layers.gatedgcn_layer import GatedGCNLayer
from models.gps.layers.gine_conv_layer import GINEConvESLapPE
...
class GPSLayer(nn.Module):
    ...
    def forward(self, batch):
        ...
        if self.self_attn is not None:
            # TODO: Use actual 'max_num_nodes' calculation
            h_dense, mask = to_dense_batch(h, batch=batch.batch)
