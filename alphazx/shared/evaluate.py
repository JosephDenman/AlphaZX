"""
Neural network evaluation utilities (shared across training paradigms).
...
Used by both MCTS (AlphaZero) and GFlowNet training pipelines.
"""
...
def evaluate_state(
    ...
    # edge_type is passed for heterogeneous models (AlphaZXHeteroModel);
    # homogeneous AlphaZXModel accepts but ignores it.
...
def evaluate_states_batch(
    ...
    # edge_type is passed for heterogeneous models; homogeneous ignores it.
