"""
GameState: a lightweight, copyable snapshot of a ZX diagram for search and training.

Used by both MCTS (AlphaZero) and GFlowNet training paradigms.
...
That belongs in the training loop (self-play, trajectory sampling, etc.).
"""
