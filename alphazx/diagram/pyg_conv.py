...
def compute_edge_size_attr(number_of_edges: int, m: Match, n: Match) -> int:
    return number_of_edges if isinstance(m, FRightMatch) and isinstance(n, FRightMatch) else 1
