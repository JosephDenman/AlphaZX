...
from src.diagram.match import Match, FRightMatch, FRightZMatch, FRightXMatch, FLeftZMatch, FLeftMatch, FLeftXMatch, \
    BLeftMatch, BRightMatch, YLeftMatch, YRightMatch, YLeftXMatch, YLeftZMatch, YRightZMatch, YRightXMatch
from src.diagram.pyzx_nx_conv import is_basis, is_boundary, is_z_basis, is_x_basis, \
...
class ZXDiagram(nx.MultiGraph):
    ...
    def f_right_z_matches(self) -> Iterator[FRightZMatch]:
        yield from (FRightZMatch(z) for z in self.z_nodes())

    def f_right_x_matches(self) -> Iterator[FRightXMatch]:
        yield from (FRightXMatch(x) for x in self.x_nodes())
