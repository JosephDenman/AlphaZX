...
from matching.base import RuleMode, rule_mode_to_ntype_indices, node_attributes_equal, filter_permutations, Matches, \
    YRightMatch, YLeftMatch, dicts_to_tuples
...
def match_y_left_x(nx_graph: nx.MultiGraph) -> Matches[YLeftMatch]:
...
def match_y_right_x(nx_graph: nx.MultiGraph) -> Matches[YRightMatch]:
